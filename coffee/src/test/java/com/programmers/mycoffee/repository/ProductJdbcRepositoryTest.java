...
import static com.wix.mysql.distribution.Version.v5_7_18;
...
class ProductJdbcRepositoryTest {
    ...
    @BeforeAll
    static void setup() {
        var config = aMysqldConfig(v5_7_18)
    ...
    private final Product newProduct = new Product(UUID.randomUUID(), "new-product.html", Category.COFFEE_BEAN_PACKAGE, 1000L);
